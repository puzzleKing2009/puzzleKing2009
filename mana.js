	...
	function calcManaPercent(x){
		...
		var fillPercent = Math.round((1-(Math.pow(Math.E, (manaDump*-1)/987654321)))*10000)/100;
	...
	function calcMoanaPercent(x){
		...
		var fillPercent = Math.round((1-(Math.pow(Math.E, (moanaDump*-1)/8000000000000000)))*10000)/100;
